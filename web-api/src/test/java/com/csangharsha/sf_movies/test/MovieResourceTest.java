...
import com.csangharsha.sf_movies.domains.movies.Movie;
import com.csangharsha.sf_movies.domains.movies.MovieDto;
import com.csangharsha.sf_movies.domains.movies.MovieMapper;
import com.csangharsha.sf_movies.domains.movies.MovieService;
...
public class MovieResourceTest {
	...
	public void init() {
		...
		movieDTO.setId("180_555_Market_St");
	...
	public void testCreate() throws Exception {
		...
		mockMvc.perform(post("/api/movies").contentType(MediaType.APPLICATION_JSON_VALUE).content(movieJSON))
				.andExpect(status().is2xxSuccessful()).andExpect(jsonPath("$.id", is("180_555_Market_St")));

	}

	@Test
	public void testCreateWithIdNotNull() throws Exception {
		String movieJSON = "{\"id\":\"180_555_Market_St\",\"title\":\"180\","
	...
	public void testUpdateWithEmptyLocation() throws Exception {
		String id = "180_555_Market_St";
		String movieJSON = "{\"id\":\"180_555_Market_St\","
	...
	public void testUpdateWithNullLatAndLong() throws Exception {
		String id = "180_555_Market_St";
		String movieJSON = "{\"id\":\"180_555_Market_St\",\"title\":"
	...
	public void testUpdateAll() throws Exception {
		...
		mockMvc.perform(put("/api/movies/" + id).contentType(MediaType.APPLICATION_JSON_VALUE).content(movieJSON))
				...
				.andExpect(jsonPath("$.id", is("180_555_Market_St")));
